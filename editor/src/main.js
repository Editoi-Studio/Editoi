...
FN.menuOptions.start = () => {
  ...
  var val = localStorage.getItem('author')
  if(val) {
    DATA.author = val
    $(".menuItem3").val(val)    
  }  
...
TEMPLATE.menuAbout = () => {
  let template = gg({
    ...
    html: `
      ...
      <div> Github: <a href="https://github.com/Editoi-Studio/Editoi" target="_blank">github.com/Editoi-Studio/Editoi</a> </div>
      <div> Discord: <a href="https://discord.gg/48AHpUYnhJ" target="_blank">discord.gg/48AHpUYnhJ</a> </div>
<br>
